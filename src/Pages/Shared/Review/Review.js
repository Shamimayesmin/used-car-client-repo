...
const Review = () => {
	return (
		<section className="my-20 dark:bg-gray-800 dark:text-gray-100">
			<div className="container flex flex-col items-center mx-auto md:p-10 md:px-12">
				<h1 className="text-2xl text-red-600 font-bold leading-none text-center font-serif">
					What our customers are saying about us
				</h1>
               
			</div>
            <hr className="text-black w-1/2 mx-auto font-extrabold" />
